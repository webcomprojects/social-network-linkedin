        ...
        <div class="d-flex justify-content-between mb-8">
            <div class="d-flex">
                ...
                @if (isset($type)&&$type=="page")
                    <div class="">
                        <a href="#"><img class="rounded-circle height-40px h-39" src="{{get_page_logo($comment->photo, 'logo')}}" alt="Profile photo"></a>
                    </div>
                @else
                    <div class="">
                        <a href="#"><img class="rounded-circle height-40px h-39" src="{{get_user_image($comment->photo, 'optimized')}}" alt="Profile photo"></a>
                    </div>
                @endif
