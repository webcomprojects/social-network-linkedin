                ...
                <div class="col-xl-12 order-xl-1 order-2">
                    <form action="{{ route('save.payment.settings') }}" method="post" class=" create-article payform">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary py-2 mt-3 px-3">{{get_phrase('Save settings')}}</button>
                        </div>
                    </form>
                </div>


                {{-- <div class="col-xl-3 order-xl-2 order-1 mt-12">
                    <div class="alert alert-warning rounded-3" role="alert">
                        <h5 class="alert-heading">Be careful!</h5>
                        <p>{{get_phrase('Just configure the payment gateway you want to use,
                            leave
                            the rest
                            blank.')}}</p>
                        <hr>
                        <p>{{get_phrase('Also, make sure that you have configured your payment
                            settings
                            correctly')}}</p>
                    </div>
                </div> --}}
