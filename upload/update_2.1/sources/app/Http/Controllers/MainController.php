...
class MainController extends Controller
{
    ...
    public function live_streaming($id)
    {
        ...
        Live_streamings::where('publisher_id', $id)->update(['details->join_pass' => $join_pass]);

        $room = get_settings('system_name') . $user->name . Str::random(10);
