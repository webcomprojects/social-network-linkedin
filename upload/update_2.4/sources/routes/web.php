...
// Memories Controller
Route::controller(MemoriesController::class)->middleware('auth', 'verified', 'activity', 'prevent-back-history')->group(function () {
    Route::get('/memories', 'memories')->name('memories');
    Route::get('/load/memories', 'load_memories')->name('load.memories');
});

// Badge  Controller
Route::controller(BadgeController::class)->middleware('auth', 'verified', 'activity','prevent-back-history')->group(function () {
