            ...
            <form method="GET" action="{{ route('filter.product') }}" class=" row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 gm-2">
                        <div class="form-group ">
                            <input type="number" class="submit_on_enter pl-18" value="@if(isset($_GET['min']) && $_GET['min']!="" ){{$_GET['min']}}@endif" name="min" placeholder="min">
                        </div>
                    </div>
                    <div class="col-md-4 gm-2">
                        <div class="form-group ">
                            <input type="number" class="submit_on_enter pl-18" value="@if(isset($_GET['max']) && $_GET['max']!="" ){{$_GET['max']}}@endif" name="max" placeholder="max">
                        </div>
                    </div>
                    {{-- <div class="col-md-4">
                        <div class="form-group">
