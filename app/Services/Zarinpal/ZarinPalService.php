...
class ZarinPalService
{
     ...
     * @param string|null $currency Payment Currency (optional)
     * @return array
     */
    public function request(int $amount, string $callbackUrl, string $description, string $email = null, string $mobile = null, string $currency=null)
    {
        $currency = $currency ?? env('ZARINPAL_CURRENCY');
