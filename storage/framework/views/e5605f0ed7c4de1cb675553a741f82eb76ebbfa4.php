                   ...
                   <article class="single-entry batch-entry  h-100 p-0">
                       <div class="entry-txt p-8">
                           ...
                           <div class="batch E_new_batch">
                            <h4><?php echo e(get_phrase('Confirm and pay')); ?></h4>
                            <p><?php echo e(get_phrase('You are subscribing to Meta Verified on Sociopro.')); ?></p>
                               <div class="demo-badge E_badge">
                                   <div class="badge-image  d-flex">
                                       ...
                                       <div>
                                            ...
                                            <p class="socio-text"><?php echo e(get_phrase('Sociopro')); ?></p>
                                       </div>
                                   </div>
                                   <h4><?php echo e(get_phrase("You'll be billed")); ?> <?php echo e(currency(get_settings('badge_price'))); ?> <?php echo e(get_phrase('per month.')); ?></h4>

                               </div>
                               <h3><?php echo e(get_phrase('What you get with your subscription.')); ?></h3>
                               <form action="<?php echo e(route('badge.payment_configuration',['id' =>  auth()->user()->id ])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <ul class="entry_badge">
                                    <li>
                                        <i class="fa-solid fa-check"></i>
                                        <div class="entry_badge_text">
                                            <label for="title"><?php echo e(get_phrase('A verified badge')); ?></label>
                                    ...
                                    <li>
                                        <i class="fa-solid fa-check"></i>
                                        <div class="entry_badge_text">
                                            <label for="description"><?php echo e(get_phrase('Increased account protection')); ?></label>
                                            <input id="description" type="hidden" name="description"  value="Increased account protection" required>
                                        </div>
                                    </li>
                                </ul>
                                <button type="submit" class="btn common_btn w-100"><?php echo e(get_phrase('Pay Now')); ?></button>
                              </form>
                       </div>
                   </article>
               </div>
   ...
   </div> <!-- Page Wrap End --><?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/frontend/badge/badge_info.blade.php ENDPATH**/ ?>