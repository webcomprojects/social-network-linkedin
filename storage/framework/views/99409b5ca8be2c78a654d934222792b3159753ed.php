<script>
    ...
    function searchFriendsForInviting(e, showOn){
        ...
        timer = setTimeout(function () {
            $.ajax({
				type: 'get',
				url: '<?php echo e(url("/search_friends_for_inviting")); ?>',
				headers: {
...
<?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/groups/script.blade.php ENDPATH**/ ?>