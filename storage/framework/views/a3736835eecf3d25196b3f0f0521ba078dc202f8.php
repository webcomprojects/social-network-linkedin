<div class="cts-wrap">
    <div class="entry-header d-flex justify-content-between mb-5">
        <div class="ava-info d-flex align-items-center">
            <div class="flex-shrink-0">
                <img src="<?php echo e(get_user_image(Auth()->user()->id, 'optimized')); ?>" class="rounded-circle user_image_show_on_modal" alt="...">
            </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="privacyDroupdownBtn">
                <li><a class="dropdown-item" href="javascript:void(0)" onclick="story_privacy('private', this)"><i class="fa-solid fa-user"></i> <?php echo e(get_phrase('Only Me')); ?></a>
                </li>
                <li><a class="dropdown-item" href="javascript:void(0)" onclick="story_privacy('friends', this)"><i class="fa-solid fa-users"></i> <?php echo e(get_phrase('Friends')); ?></a>
                </li>
                <li><a class="dropdown-item" href="javascript:void(0)" onclick="story_privacy('public', this)"><i class="fa-solid fa-user-group"></i> <?php echo e(get_phrase('Public')); ?></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('create_story')); ?>" class="text-form text-story-form" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <img class="text-imogi" src="<?php echo e(asset('storage/images/smile.png')); ?>" alt="">
            ...
            <form action="<?php echo e(route('create_story')); ?>" method="post" class="text-form d-hidden file-story-form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="input-prev">
                    <a href="javascript:void(0)" onclick="$('#file-story-input').click()" class="d-block body-bg file">
                        ...
                        <?php echo e(get_phrase('Create Photo / Video Story')); ?></a>
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="#" onclick="storyType(this, 'text-type-story')" class="mt-2 border text-type-story">
                    ...
                    <?php echo e(get_phrase('Create a Text Story')); ?></a>
            </div>
            <div class="col-md-6">
...
<div class="d-flex story-buttons gap-3 mt-4">
    <a href="javascript:void(0)" onclick="createStory('text-story-form');" class="btn common_btn text-story-submit"><?php echo e(get_phrase('Share to story')); ?></a>
    <a href="javascript:void(0)" onclick="createStory('file-story-form');" class="btn common_btn file-story-form d-hidden"><?php echo e(get_phrase('Share to story')); ?></a>
    <a href="javascript:void(0)" class="btn common_btn" data-bs-dismiss="modal" aria-label="Close"><?php echo e(get_phrase('Discard')); ?></a>
</div><?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/story/create_story.blade.php ENDPATH**/ ?>