...
<!--<script src="https://www.paypal.com/sdk/js?client-id=<?php echo e($client_id); ?>&enable-funding=venmo&currency=<?php echo e(get_settings('system_currency')); ?>" data-sdk-integration-source="button-factory"></script>-->
<script>
          ...
          paypal.Button.render({
            ...
            onAuthorize: function(data, actions) {
              ...
              return actions.payment.execute().then(function() {
                ...
                //console.log(data)
                window.location = "<?php echo e($payment_details['success_url'].'/'.$payment_gateway->identifier); ?>"+"?payment_id="+data.paymentID+"&payment_token="+data.paymentToken+"&payer_id="+data.payerID
              });
            }
...
</script><?php /**PATH C:\Users\PicoNet\Desktop\linkedin\resources\views/payment/paypal/index.blade.php ENDPATH**/ ?>