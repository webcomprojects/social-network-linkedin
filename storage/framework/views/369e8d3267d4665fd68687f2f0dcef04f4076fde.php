...
<div class="event-page-wrap">
    <div
        ...
        <h3 class="h5 mb-0"><span><i class="fa-solid fa-calendar-days"></i></span> <?php echo e(get_phrase('Events')); ?></h3>
        <div class="">
            <button onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.events.create_event'])); ?>', '<?php echo e(get_phrase('Create Event')); ?>');" class="btn common_btn btn-sm" data-bs-toggle="modal"
            ...
            <a href="<?php echo e(route('userevent')); ?>" class="btn  btn-sm ms-2 <?php if(Route::currentRouteName() == 'userevent'): ?> common_btn_2 <?php else: ?> common_btn <?php endif; ?> "><?php echo e(get_phrase('My Event')); ?></a>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-xl-4 col-md-4 col-sm-6" id="event-<?php echo e($event->id); ?>">
                ...
                <div class="card event-card m_product m_event">
                    ...
                    <div class="event-text ev_body og_event_text mt-3">
                        ...
                        <h3 class="elips_con"><a class="ellipsis-line-2" href="<?php echo e(route('single.event',$event->id)); ?>"><?php echo e($event->title); ?></a></h3>
                        <div class="organiser elips_con  d-flex  align-items-center">
                            <a href="<?php echo e(route('user.profile.view', $event['user_id'])); ?>"><img src="<?php echo e(get_user_image($event->getUser->photo, 'optimized')); ?>"  width="35" class="user-round" alt=""></a>
...
<?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/frontend/events/user_event.blade.php ENDPATH**/ ?>