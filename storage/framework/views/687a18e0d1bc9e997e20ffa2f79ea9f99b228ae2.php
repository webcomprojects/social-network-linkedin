                ...
                <div class="row">
                    <div class="col-12 p-4">
                        ...
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span class="float-end"><?php echo e(get_settings('purchase_code')); ?></span>
                        </p>
                        ...
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span
                                class="float-end badge bg-success text-capitalize"><?php echo e(get_phrase($application_details['product_license'])); ?></span>
                            <?php else: ?>
                            <span
                                class="float-end badge bg-danger mt-1 text-capitalize"><?php echo e(get_phrase($application_details['product_license'])); ?></span>
                            <button class="btn btn-primary float-end me-2 py-0 text-13px" data-bs-toggle="modal"
                                data-bs-target="#purchasecodeModal"><?php echo e(get_phrase('Enter valid purchase code')); ?></button>
                            <?php endif; ?>
                        </p>
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span class="float-end">
                                ...
                                <span
                                    class="badge bg-danger float-end mt-1 text-capitalize"><?php echo e(get_phrase($application_details['purchase_code_status'])); ?></span>
                                <a href="https://codecanyon.net/user/creativeitem/portfolio" target="_blank"
                                    class="btn btn-success float-end me-2 py-0 text-13px"><?php echo e(get_phrase('Renew support')); ?></a>
                                <?php elseif (strtolower($application_details['purchase_code_status']) == 'valid'): ?>
                                <span
                                    class="badge bg-success text-capitalize"><?php echo e(get_phrase($application_details['purchase_code_status'])); ?></span>
                                <?php else: ?>
                                <span
                                    class="badge bg-danger text-capitalize"><?php echo e(get_phrase($application_details['purchase_code_status'])); ?></span>
                                <?php endif; ?>
                            </span>
                        </p>
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span class="float-end"><?php echo e($application_details['support_expiry_date']); ?></span>
                            <?php else: ?>
                            <span class="float-end"><span
                                    class="badge bg-danger"><?php echo e(ucfirst($application_details['support_expiry_date'])); ?></span></span>
                            <?php endif; ?>
                        </p>
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span class="float-end"><?php echo e($application_details['customer_name']); ?></span>
                            <?php else: ?>
                            <span class="float-end"><span
                                    class="badge bg-danger"><?php echo e(ucfirst($application_details['customer_name'])); ?></span></span>
                            <?php endif; ?>
                        </p>
                        <p class="border-bottom mb-2 pb-2 text-13px">
                            ...
                            <span class="float-end"><a class="about-sc-one" href="http://support.creativeitem.com"
                                    ...
                                    <?php echo e(get_phrase('Customer support')); ?> </a> </span>
                        </p>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo $__env->make('backend.admin.setting.save_purchase_code', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/backend/admin/setting/system_about.blade.php ENDPATH**/ ?>