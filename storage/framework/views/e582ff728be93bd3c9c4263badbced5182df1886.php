<div class="page-content ng_page_tab">
    <div class="page-tab bg-white   p-3 pb-1">
        <div class="d-flex pagetab-head  justify-content-between">
            ...
            <a href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.pages.create_page'])); ?>', '<?php echo e(get_phrase('Create Page')); ?>');"  data-bs-toggle="modal"
                data-bs-target="#createPage" class="btn common_btn"> <i class="fa fa-plus-circle"></i><?php echo e(get_phrase('Create Page')); ?></a>
        </div>
...
<?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/pages/pages.blade.php ENDPATH**/ ?>