            ...
            <div class="col-lg-6">
                ...
                <div class="ms-0 ms-lg-5 my-5">
                    ...
                    <form method="POST" action="<?php echo e(route('verification.send')); ?>">
                        ...
                        <div>
                            <button type="submit"
                                class="btn btn-primary w-100 p-10px rounded-10px"><?php echo e(get_phrase('Resend Verification Email')); ?></button>
                        </div>
                    </form>
...
<!-- Main End -->
<?php echo $__env->make('auth.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PicoNet\Desktop\linkedin\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>