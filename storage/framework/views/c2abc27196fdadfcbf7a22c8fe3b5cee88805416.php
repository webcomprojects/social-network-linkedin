<?php $__currentLoopData = $friend_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $friend_request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="single-item-countable col-6" id="friendRequest<?php echo e($requester_user_data->id); ?>">
	    <div class="card">
	        <div class="mb-2"><img src="<?php echo e(get_user_image($requester_user_data->photo, 'optimized')); ?>" class="rounded-circle user_image_show_on_modal img-fluid" alt=""></div>
	        <div class="card-details">
	            <h6><a href="#"><?php echo e($requester_user_data->name); ?></a></h6>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/user/single_user/friend_requests_single_data.blade.php ENDPATH**/ ?>