        ...
        <div class="d-flex pagetab-head   align-items-center justify-content-between mb-12 py-2 px-3 ">
            ...
            <div class="">
                <a href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.marketplace.create_product'])); ?>', '<?php echo e(get_phrase('Create Product')); ?>');" data-bs-toggle="modal"
                    data-bs-target="#createProduct" class="btn common_btn py-2"> <i class="fa fa-plus-circle"></i> <?php echo e(get_phrase('Create Product')); ?></a>
            </div>
        </div>
    </nav>
                    ...
                    <div class="card m_product product">
                       ...
                       <div class="p-8">
                            ...
                            <div class="prodoct-footer mt-0 np_footer">
                                <a href="<?php echo e(route('single.product',$product->id)); ?>" class="btn common_btn"><?php echo e($product->getCurrency->symbol); ?> <?php echo e($product->price); ?></a>
...
</div><?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/frontend/marketplace/user_products.blade.php ENDPATH**/ ?>