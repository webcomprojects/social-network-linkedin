<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/nice-select.css')); ?>">
    <form class="ajaxForm event-form form_sel" action="<?php echo e(route('event.store')); ?>" method="POST" enctype="multipart/form-data" >
        <?php echo csrf_field(); ?>
        ...
        <div class="inline-btn mt-5">
            <button class="btn common_btn w-100" type="submit" onclick="document.getElementById('description').value=CKEDITOR.instances.description.getData(); CKEDITOR.instances.description.destroy()"><?php echo e(get_phrase('Create Event')); ?></button>
        </div>
    </form>  
...
</script><?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/frontend/events/create_event.blade.php ENDPATH**/ ?>