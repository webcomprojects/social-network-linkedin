...
<div class="footer-modal-share">
    ...
    <div class="inner-share d-flex" id="myTab" role="tablist">
        <button class="btn btn-secondary btn-sm px-3" id="timelinePostBtn"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg> <?php echo e(get_phrase('My Timeline')); ?></button>

        <button class="btn btn-secondary btn-sm px-3 mx-2" id="messageSendButton"><i class="fa-regular fa-message"></i> <?php echo e(get_phrase('Send in Message')); ?></button>
        <button class="btn btn-secondary btn-sm px-3" id="groupPostButton"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg><?php echo e(get_phrase('Share to a Group')); ?>
    ...
    <form class="ajaxForm" action="<?php echo e($post_route); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if(isset($post_id)&&!empty($post_id)): ?>
                ...
                <?php if(isset($is_memory)): ?>
                    <input type="hidden" name="is_memory" value="<?php echo e($post_id); ?>">
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php endif; ?>
        <button type="submit" class="btn common_btn mt-3 rounded w-100 btn-lg" id="ShareButton"><?php echo e(get_phrase('Share')); ?></button>
    </form>
</div>
...
<?php /**PATH /home3/kigbvjze/linkdin.webcomdemo.ir/resources/views/frontend/main_content/share_post_modal.blade.php ENDPATH**/ ?>