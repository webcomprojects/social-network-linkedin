    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                <button type="submit" class="btn common_btn d-block w-100 btn-lg"><?php echo e(get_phrase('Invite Group')); ?></button>
            </form>
            </div>
...
<?php echo $__env->make('frontend.groups.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/groups/invite.blade.php ENDPATH**/ ?>