...
<?php if($key != ''): ?>
    <a href="<?php echo e(route('payment.create', $payment_gateway->identifier)); ?>"
        class="btn btn-primary py-2 px-3"><?php echo e(get_phrase('Pay by Stripe')); ?></a>
<?php else: ?>
    ...
    <div class="alert alert-danger d-flex align-items-center" role="alert">
        ...
        <div class="payment_err_msg">
            <b>Opps!</b> <?php echo e($msg); ?><br>
            Try another gateway.
        </div>
    </div>
<?php endif; ?>
<?php /**PATH C:\Users\PicoNet\Desktop\linkedin\resources\views/payment/stripe/index.blade.php ENDPATH**/ ?>