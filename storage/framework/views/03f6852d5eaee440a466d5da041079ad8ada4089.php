<?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <?php if($is_invited=='0'): ?>
        <div class="single-suggest nSuggest d-flex justify-content-between align-items-center" onclick="inviteGroupPeople('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                   ...
                                                   <?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/groups/invite-user.blade.php ENDPATH**/ ?>