<?php $__currentLoopData = $friend_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $friend_request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	?>
	<div class="single-item-countable w-100 " id="friendRequest<?php echo e($requester_user_data->id); ?>">
	    <div class="card request_f bg-white">
	        <div class="f_images"><img src="<?php echo e(get_user_image($requester_user_data->photo, 'optimized')); ?>" class="rounded img-fluid" alt=""></div>
	        <div class="card-details">
	            ...
	            <div class="card-control d-flex">
	            	<form class="ajaxForm" action="<?php echo e(route('profile.accept_friend_request')); ?>" method="post">
	                	...
	                	<button type="submit" id="friendRequestConfirmBtn<?php echo e($requester_user_data->id); ?>" class="btn common_btn_2 w-100"><?php echo e(get_phrase('Confirm')); ?></button>
	                	<button type="button" id="friendRequestAcceptedBtn<?php echo e($requester_user_data->id); ?>" class="btn common_btn_2  w-100 d-hidden"><?php echo e(get_phrase('Accepted')); ?></button>
	                </form>
	                <a href="javascript:void(0)" onclick="confirmAction('<?php echo route('profile.delete_friend_request', ['user_id' => $requester_user_data->id]); ?>', true)" class="btn del_btn d-block"><?php echo e(get_phrase('Delete')); ?></a>
	            </div>
	        </div>
	    </div>
	</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/profile/friend_requests_single_data.blade.php ENDPATH**/ ?>