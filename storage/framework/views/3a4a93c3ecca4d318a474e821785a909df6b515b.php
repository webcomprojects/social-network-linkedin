                    ...
                    <div class="entry-txt p-8">
                        ...
                        <div class="batch">
                            <div class="demo-badge">
                                <h4><?php echo e(get_phrase('Build trust with Sociopro Verified')); ?></h4>
                            ...
                            <ul class="entry_badge">
                                <li>
                                    ...
                                    <div class="entry_badge_text">
                                        <h5><?php echo e(get_phrase('A verified badge')); ?></h5>
                                ...
                                <li>
                                    <i class="fa-solid fa-circle-check"></i>
                                    <div class="entry_badge_text">
                                        <h5><?php echo e(get_phrase('Increased account protection')); ?></h5>
                           ...
                           <?php if($badge_info?->status == '1' && $badge_info->start_date <= now() && $badge_info->end_date >= now()): ?>
                            <a href="javascript:;" class="btn common_btn_2 next w-100"><?php echo e(get_phrase('Already purchased')); ?></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('badge.info')); ?>" class="btn  common_btn w-100"><?php echo e(get_phrase('Next')); ?></a>
                            <?php endif; ?>
...
</div> <!-- Page Wrap End --><?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/badge/badge.blade.php ENDPATH**/ ?>