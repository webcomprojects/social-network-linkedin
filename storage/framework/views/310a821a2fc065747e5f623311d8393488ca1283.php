    ...
    <div class="col-lg-12">
        <div class="group-inner n_group bg-white  p-3">
            <div class="gr-search">
                ...
                <form action="<?php echo e(route('search.group')); ?>" class="ag_form" method="GET">
            ...
            <div class="page-suggest mt-4">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="card eg_card p-2">
                                  ...
                                  <div class="card-head">
                                    <a href="<?php echo e(route('single.group',$group->id)); ?>"><img src="<?php echo e(get_group_logo($group->logo,'logo')); ?>" alt=""></a>
                                  </div>
                                   
                                    <div class="card-body">
                                             <div class="motion_text">
                                                <a href="<?php echo e(route('single.group',$group->id)); ?>"><h4><?php echo e(ellipsis($group->title,24)); ?></h4></a>
                                                <?php $joined = \App\Models\Group_member::where('group_id',$group->id)->where('is_accepted','1')->count(); ?>
                                                <ul class="figure_p d-flex ">
                                                    <li><?php echo e($group->privacy); ?></li>
                                                    <li><?php echo e($joined); ?> <?php echo e(get_phrase('Member')); ?><?php echo e($joined>1?"s":""); ?></li>
                                            ...
                                            <div class="join_groups">
                                                ...
                                                <?php if($join>0): ?>
                                                    <?php if($group->user_id==auth()->user()->id): ?>
                                                        <a href="javascript:void(0)" class="btn common_btn"><?php echo e(get_phrase('Admin')); ?></a>
                                                    <?php else: ?>
                                                      ...
                                                      <?php echo e(get_phrase('Joined')); ?></a>
                                                    <?php endif; ?>
                                                <?php else: ?>
                ...
                <?php if(count($groups)>15): ?>
                    <a href="<?php echo e(route('all.group.view')); ?>" class="btn common_btn btn-lg d-block mt-3"><?php echo e(get_phrase('See More')); ?></a>
                <?php endif; ?>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH /Applications/MAMP/htdocs/Sociopro_2.6/Sociopro/resources/views/frontend/groups/groups.blade.php ENDPATH**/ ?>