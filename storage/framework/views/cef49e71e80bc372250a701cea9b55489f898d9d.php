  ...
  <body class="pt-5">
    <div class="main_content paymentContent" style="min-height: calc(100% - 50px); margin-top: 0px !important;">
      <div class="paymentHeader d-flex justify-content-between align-items-center">
        <h5 class="title"><?php echo e(get_phrase('Order summary')); ?></h5>
        <a href="<?php echo e($payment_details['cancel_url']); ?>" class="btn-close"></a>
      </div>
...
</html><?php /**PATH C:\Users\PicoNet\Desktop\linkedin\resources\views/payment/index.blade.php ENDPATH**/ ?>